...
| v1.21.x | **冲突与和好弧**：关系事件状态机（收编 v1.14 冷落+重逢/v1.7 低能量/escalation，红线确定性护栏，docs/CONFLICT_ARC.md）+ .1 上线收尾（记忆放行/arc:digest/运维钳位/落地页诚实化）+ .2 静默失败变响（ESLint/错误签名/死人开关）与照片比例修复 | ✅ |
...
*Last updated: 2026-06-10（对应 v1.21.1）*
